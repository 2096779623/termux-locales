...
# installed.
TCL_PREFIX='/data/data/com.termux/files/usr/glibc'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/data/data/com.termux/files/usr/glibc'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/data/data/com.termux/files/usr/glibc/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/data/data/com.termux/files/usr/glibc/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/data/data/com.termux/files/usr/glibc/include'
...
# compiled.
TCL_SRC_DIR='/data/data/com.termux/files/usr/glibc/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/data/data/com.termux/files/usr/glibc/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/data/data/com.termux/files/usr/glibc/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/data/data/com.termux/files/usr/glibc/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/data/data/com.termux/files/usr/glibc/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/data/data/com.termux/files/usr/glibc/lib/libtclstub8.6.a'
